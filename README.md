  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        ...
        <li><a href="#self---assigned-project---creating-fake-monet---images-with-style-transfer-and-classifying-them-with-cnns">Self-assigned project - Creating fake Monet-images with style transfer and classifying them with CNNs</a></li>
      </ul>
    </li>
